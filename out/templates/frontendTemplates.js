...
exports.FrontendTemplates = void 0;
class FrontendTemplates {
    ...
    getReadmeContent(projectName, projectType) {
        return `# ${projectName}
...
@media (max-width: 768px) {
  ...
  .features {
    ...
    getIndexHtmlContent(projectName) {
        return `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
...
exports.FrontendTemplates = FrontendTemplates;
//# sourceMappingURL=frontendTemplates.js.map