...
exports.FullStackTemplates = void 0;
class FullStackTemplates {
    getStructure(projectName) {
        return {
            folders: [
                'client',
                'client/src',
...
`;
    ...
    getRootPackageJsonContent(projectName) {
        return `{
  "name": "${projectName}",
  "version": "1.0.0",
...
networks:
  app-network:
    ...
    getClientPackageJsonContent(projectName) {
        return `{
...
exports.FullStackTemplates = FullStackTemplates;
//# sourceMappingURL=fullStackTemplates.js.map