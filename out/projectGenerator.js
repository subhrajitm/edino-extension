...
class ProjectGenerator {
    ...
    getMobileStructure(projectName) {
        return {
            folders: [
                'src',
                'src/components',
    ...
    getDesktopStructure(projectName) {
        return {
            folders: [
                'src',
                'src/main',
    ...
    getLibraryStructure(projectName) {
        return {
            folders: [
                'src',
                'src/index',
    ...
    getMobileReadmeContent(projectName) {
        return `# ${projectName}
...
`;
    ...
    getMobilePackageJsonContent(projectName) {
...
`;
    ...
    getDesktopReadmeContent(projectName) {
        return `# ${projectName}
...
`;
    ...
    getDesktopPackageJsonContent(projectName) {
        return JSON.stringify({
            name: projectName.toLowerCase().replace(/\s+/g, '-'),
            version: '1.0.0',
...
`;
    ...
    getLibraryReadmeContent(projectName) {
        return `# ${projectName}
...
`;
    ...
    getLibraryPackageJsonContent(projectName) {
        return JSON.stringify({
            name: projectName.toLowerCase().replace(/\s+/g, '-'),
            version: '1.0.0',
...
`;
    ...
    getCliReadmeContent(projectName) {
        return `# ${projectName}
...
`;
    ...
    getCliPackageJsonContent(projectName) {
        return JSON.stringify({
            name: projectName.toLowerCase().replace(/\s+/g, '-'),
            version: '1.0.0',
...
`;
    ...
    getAiMlReadmeContent(projectName) {
        return `# ${projectName}
